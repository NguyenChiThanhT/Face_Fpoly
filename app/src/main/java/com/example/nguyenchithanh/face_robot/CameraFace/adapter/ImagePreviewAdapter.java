package com.example.nguyenchithanh.face_robot.CameraFace.adapter;
...
import com.example.nguyenchithanh.face_robot.Activity.IdentificationActivity;
...
public class ImagePreviewAdapter extends
    ...
    // Provide a direct reference to each of the views within a data item_mast
    // Used to cache the views within the item_mast layout for fast access
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        // We also create a constructor that accepts the entire item_mast row
